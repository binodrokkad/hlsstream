...
void Demuxer::configParser()
{
    ...
    if (m_videoStreamIdx >= 0)
    {
        ...
        m_videoCodec = codecParameter->codec_id == AV_CODEC_ID_H264 ? VIDEO_CODEC_H264 :
            codecParameter->codec_id == AV_CODEC_ID_H265 ? VIDEO_CODEC_H265 : VIDEO_CODEC_UNKNOWN;
    ...
    if (m_audioStreamIdx >= 0)
    {
        ...
        m_audioCodec = codecParameter->codec_id == AV_CODEC_ID_AAC ? AUDIO_CODEC_AAC :
            codecParameter->codec_id == AV_CODEC_ID_MP3 ? AUDIO_CODEC_MP3 : AUDIO_CODEC_UNKNOWN;
